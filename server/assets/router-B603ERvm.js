...
const appCss = "/Navship/assets/styles-BYSqWvbh.css";
...
const Route$2 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Estaleiro NavShip: soluções de construção e reparo naval com excelência técnica, segurança e eficiência em Navegantes, Santa Catarina."
      },
      { name: "author", content: "NavShip" },
      ...
      { name: "twitter:title", content: "NavShip — Estaleiro de construção e reparo naval" },
      {
...
const $$splitComponentImporter$1 = () => import("./lgpd-BF0MMd65.js");
const Route$1 = createFileRoute("/lgpd")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Política de Privacidade e Segurança de Dados do Estaleiro NavShip em conformidade com a Lei Geral de Proteção de Dados (LGPD)."
    }, {
      property: "og:title",
      content: "Política de Privacidade e Segurança de Dados (LGPD) — NavShip"
    }, {
      property: "og:description",
      content: "Conheça como o Estaleiro NavShip trata e protege seus dados pessoais conforme a LGPD."
    }]
  })
});
const $$splitComponentImporter = () => import("./index-DnbUXxYf.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Estaleiro NavShip: soluções de construção e reparo naval com excelência técnica, segurança e eficiência. Localizado em Navegantes, Santa Catarina."
    }, {
      property: "og:title",
      content: "NavShip — Estaleiro de construção e reparo naval"
    }, {
      property: "og:description",
      content: "Engenharia naval com precisão. Construção, reparo, conversões e apoio offshore."
    }]
  })
});
const LgpdRoute = Route$1.update({
  id: "/lgpd",
  path: "/lgpd",
